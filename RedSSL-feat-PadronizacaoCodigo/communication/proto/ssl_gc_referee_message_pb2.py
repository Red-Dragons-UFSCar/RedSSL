...
import communication.proto.ssl_gc_game_event_pb2 as ssl__gc__game__event__pb2
...
_GAMEEVENTPROPOSALGROUP.fields_by_name['game_events'].message_type = ssl__gc__game__event__pb2._GAMEEVENT
